...
\bf \caption{} The four control turnpike switching surfaces in the three-dimensional
space~$ (m_1, m_2, \tau) $. A turnpike is the most efficient route in order to reach the steady-state equilibrium regimes.}
\label{Fig_7}
\end{figure}

From Figure~{\rm \ref{Fig_4},} one can see that{\rm ,} in the considered domain
